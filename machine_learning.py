...
svc.fit(iris, target)
#Prediz a que classe pertencerá a flor com sépala de comprimento 6.9cm e largura 2.8cm e pétala de comprimento 6.1cm e largura 2.3cm
svc.predict([[6.9,2.8,6.1,2.3]])

plt.scatter(iris['sepal length (cm)'], iris['petal width (cm)'], c=target)
plt.title('Iris')

#Provavelmente, ao criar 2 features novas no íris, o svm com 2 features terá mais sucesso, mas por enquanto usei só
